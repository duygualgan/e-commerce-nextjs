          ...
          {orderList.map((item, index) => (
            <Collapsible key={index}>
              <CollapsibleTrigger className="grid grid-cols-7 mt-3 items-center border borderone p-2 bgone gap-8">
                <h2>
                  {" "}
                  <span className="font-bol mr-2">Order Date :</span>{" "}
                  {moment(item?.createdAt).format("DD/MMM/yyy")}{" "}
                </h2>
                <h2>
                  {" "}
                  <span className="font-bol mr-2">Total :</span>{" "}
                  {item?.subtotal}{" "}
                </h2>
                <h2>
                  {" "}
                  <span className="font-bol mr-2">Status :</span> Pending{" "}
                </h2>
                <h2>
                  {" "}
                  <span className="font-bol mr-2">Payment :</span>{" "}
                  {item?.paymentText}{" "}
                </h2>
